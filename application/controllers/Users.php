...
class Users extends Tech008_Controller { 
    ...
    public function login(){ 
        ...
        if($this->form_validation->run() == true){ 
            ...
            if($checkLogin){ 
                ...
                $this->session->set_userdata('userName',$checkLogin['fName']);
    ...
    public function registration(){ 
        ...
        $userData = array( 
            'fName' => strip_tags($this->input->post('firstname')), 
            'LName' => strip_tags($this->input->post('lastname')), 
            'email' => strip_tags($this->input->post('email')), 
            'password' => md5($this->input->post('password')) 
        ); 
